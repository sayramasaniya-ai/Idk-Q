...
local malStroke = Instance.new("UIStroke", mobileAutoLeft); malStroke.Color = C_BORDER2; malStroke.Thickness = 1
...
local marStroke = Instance.new("UIStroke", mobileAutoRight); marStroke.Color = C_BORDER2; marStroke.Thickness = 1
